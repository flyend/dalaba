        ...
        chartProto = {
            ...
            setOptions: function(options, redraw) {
                ...
                if (defined(options.layout)) {
                    this.render("click", {
                        x: this.globalEvent.x,
                        y: this.globalEvent.y
                    });
                }
    ...
    (function(global, Dalaba) {
        ...
        Axis.prototype = {
            ...
            getCategoriesTicks: function(startValue, endValue) {
                ...
                if (isNumber(tickAmount, true) && (tickAmount = Math.max(1, ~~tickAmount)))
                        ...
                        series.forEach(function(series) {
                            ...
                            if (defined(geoJson)) {
                                ...
                                series.__projector__ = {
                                    projection: function(point) {
                                        return projected.projection.call(projected, point);
                                    },
